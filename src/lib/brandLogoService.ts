...
const BRAND_LOGOS: Record<string, { logo: string; aliases: string[] }> = {
  ...
  'a&e': { logo: WC('a/ad/A%26E_Network_logo.svg/512px-A%26E_Network_logo.svg.png'), aliases: ['ae network', 'aetv'] },
  ...
  'big ten': { logo: WC('5/5b/Big_Ten_Conference_logo.svg/512px-Big_Ten_Conference_logo.svg.png'), aliases: ['big ten network', 'btn', 'us btn'] },
