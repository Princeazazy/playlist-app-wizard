...
const BRAND_LOGOS: Record<string, { logo: string; aliases: string[] }> = {
  ...
  'al jazeera': { logo: CB('aljazeera.com'), aliases: ['الجزيرة', 'aljazeera', 'جزيرة'] },
  'al arabiya': { logo: CB('alarabiya.net'), aliases: ['العربية', 'alarabiya'] },
  'al hadath': { logo: CB('alarabiya.net'), aliases: ['الحدث'] },
  'al mayadeen': { logo: CB('almayadeen.net'), aliases: ['الميادين'] },
