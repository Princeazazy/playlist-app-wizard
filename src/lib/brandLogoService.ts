...
const BRAND_LOGOS: Record<string, { logo: string; aliases: string[] }> = {
  ...
  nbc: { logo: WC('3/3f/NBC_logo.svg/512px-NBC_logo.svg.png'), aliases: ['nbc news'] },
  ...
  fox: { logo: WC('5/53/2019_Fox_Corporation_logo.svg/512px-2019_Fox_Corporation_logo.svg.png'), aliases: ['fxx', 'fx network'] },
  ...
  discovery: { logo: WC('2/27/Discovery_Channel_logo.svg/512px-Discovery_Channel_logo.svg.png'), aliases: ['discovery channel'] },
  ...
  pbs: { logo: WC('3/3e/PBS_logo.svg/512px-PBS_logo.svg.png'), aliases: ['pbs kids'] },
  'american heroes': { logo: WC('6/67/American_Heroes_Channel.svg/512px-American_Heroes_Channel.svg.png'), aliases: ['ahc', 'american heroes channel'] },
  ...
  'big ten network': { logo: CB('btn.com'), aliases: ['big ten', 'btn', 'us btn'] },
  ...
  univision: { logo: WC('3/3b/Univision_2019.svg/512px-Univision_2019.svg.png'), aliases: ['univ'] },
  unimas: { logo: CB('unimas.com'), aliases: ['uni mas', 'uni-mas', 'unimás', 'us unimas', 'us unimas'] },
  telemundo: { logo: WC('b/bf/Telemundo_logo_2018.svg/512px-Telemundo_logo_2018.svg.png'), aliases: [] },
  'spectrum news': { logo: CB('spectrumlocalnews.com'), aliases: ['spectrum', 'us spectrum', 'us spectrum news'] },
  'the cw': { logo: WC('8/8b/The_CW.svg/512px-The_CW.svg.png'), aliases: ['cw', 'cw network'] },
  cinemania: { logo: CB('cinemania.com'), aliases: ['us cm'] },
