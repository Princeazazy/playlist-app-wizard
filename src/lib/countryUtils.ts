...
const STREAMING_SERVICES: Record<string, CountryInfo> = {
  ...
  '24 7': { name: '24/7', code: '247', flagUrl: '/images/247-logo.png', priority: 30, isStreamingService: true },
  'islamic': { name: 'Islamic', code: 'islamic', flagUrl: '/images/islamic-logo.png', priority: 32, isStreamingService: true },
  'اسلامية': { name: 'Islamic', code: 'islamic', flagUrl: '/images/islamic-logo.png', priority: 32, isStreamingService: true },
  'اسلامي': { name: 'Islamic', code: 'islamic', flagUrl: '/images/islamic-logo.png', priority: 32, isStreamingService: true },
  'إسلامية': { name: 'Islamic', code: 'islamic', flagUrl: '/images/islamic-logo.png', priority: 32, isStreamingService: true },
  'news': { name: 'Arabic News', code: 'news', flagUrl: '/images/news-logo.png', priority: 33, isStreamingService: true },
  'اخبار': { name: 'Arabic News', code: 'news', flagUrl: '/images/news-logo.png', priority: 33, isStreamingService: true },
  'الاخبار': { name: 'Arabic News', code: 'news', flagUrl: '/images/news-logo.png', priority: 33, isStreamingService: true },
  'أخبار': { name: 'Arabic News', code: 'news', flagUrl: '/images/news-logo.png', priority: 33, isStreamingService: true },
