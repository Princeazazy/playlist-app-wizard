...
const ARABIC_COUNTRIES: Record<string, CountryInfo> = {
  ...
  'dubai': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
  'دبي': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
  'abu dhabi': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
  'abudhabi': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
  'أبوظبي': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
  'ابوظبي': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
  'sharjah': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
  'الشارقة': { name: 'UAE', code: 'ae', flagUrl: 'https://flagcdn.com/w80/ae.png', priority: 4 },
...
const OTHER_COUNTRIES: Record<string, CountryInfo> = {
  ...
  'au': { name: 'Australia', code: 'au', flagUrl: 'https://flagcdn.com/w80/au.png', priority: 33 },
  'australia': { name: 'Australia', code: 'au', flagUrl: 'https://flagcdn.com/w80/au.png', priority: 33 },
  'nz': { name: 'New Zealand', code: 'nz', flagUrl: 'https://flagcdn.com/w80/nz.png', priority: 34 },
  'new zealand': { name: 'New Zealand', code: 'nz', flagUrl: 'https://flagcdn.com/w80/nz.png', priority: 34 },
  'ca': { name: 'Canada', code: 'ca', flagUrl: 'https://flagcdn.com/w80/ca.png', priority: 32 },
  'canada': { name: 'Canada', code: 'ca', flagUrl: 'https://flagcdn.com/w80/ca.png', priority: 32 },
  'canadian': { name: 'Canada', code: 'ca', flagUrl: 'https://flagcdn.com/w80/ca.png', priority: 32 },
  ...
  'ie': { name: 'Ireland', code: 'ie', flagUrl: 'https://flagcdn.com/w80/ie.png', priority: 35 },
  'ireland': { name: 'Ireland', code: 'ie', flagUrl: 'https://flagcdn.com/w80/ie.png', priority: 35 },
