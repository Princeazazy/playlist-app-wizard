...
const STREAMING_SERVICES: Record<string, CountryInfo> = {
  ...
  '24/7': { name: '24/7', code: '247', flagUrl: '', priority: 30, isStreamingService: true },
  'kids': { name: 'Kids', code: 'kids', flagUrl: '', priority: 31, isStreamingService: true },
  'jlkids': { name: 'Kids', code: 'kids', flagUrl: '', priority: 31, isStreamingService: true },
  'kids jlkids': { name: 'Kids', code: 'kids', flagUrl: '', priority: 31, isStreamingService: true },
